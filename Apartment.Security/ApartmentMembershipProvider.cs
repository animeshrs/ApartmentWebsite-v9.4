...
namespace Apartment.Security
{
    ...
    public class ApartmentMembershipProvider : MembershipProvider 
    {        
        //private static readonly List<User> Users = new List<User> {
        //new User {Username="Animesh",Password="123456" }, new User { Username="Animesh1",Password="123456"} };
        ...
        public override bool ValidateUser(string username, string password)
        {
            ...
            List<User> Users = new List<Security.User>();
            HelperClass hp = new Security.HelperClass();
            Users = hp.GetUserList();
            //var userObj = Users.Where(x => x.Username == username && x.Password == sha1Pswd);
            bool user = Users.Any(x => x.Username == username && x.Password == sha1Pswd);
            return user;           
        }
